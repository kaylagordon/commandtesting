  ...
  return (
    <div className="about" ref={nav}>
      ...
      <section className="half-page-section">
        ...
        <br/>
        <p>As a company, Command Testing strives to perform highest quality of work so that fire department personnel can depend on their life saving equipment.</p>
      </section>
    </div>
  );
}
